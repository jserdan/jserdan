...
I'm not a software engineer and I don't pretend to be. I build with no-code and low-code platforms paired with AI models for the parts that need judgment — reading a message, scoring a resume, and drafting a reply.
...
A customer support automation system for a fictional online coffee shop.
...
A separate scheduled scenario monitors SLA compliance every 4 hours, while a weekly AI-generated summary is delivered to the inbox every Monday.
...
An end-to-end hiring automation triggered by a candidate application.
